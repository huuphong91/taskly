...
//  Taskly
//
//  Created by Phong Toan Huu on 6/24/20.
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    var window: UIWindow?
    let taskStore: TaskStore = TaskStore()
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let todoTasks = [Task(name: "Mua quan"), Task(name: "Mua ao"), Task(name: "Mua giay")]
        let doneTasks = [Task(name: "Xem phim"), Task(name: "Nghe nhac")]
